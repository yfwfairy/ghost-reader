const zhTW: Record<string, string> = {
  ...
  'appearance.basicSettings': '基礎設定',
  'appearance.ghostSettings': 'Ghost 設定 ✨',
  'appearance.pageMargin': '邊距',
  'appearance.opacity': '透明度',
  'appearance.fontWeight': '字重',
  'appearance.fontWeight.regular': '常規',
  'appearance.fontWeight.medium': '中等',
  'appearance.fontWeight.semibold': '半粗',
  'appearance.fontWeight.bold': '粗體',
  ...
  'guide.moreTitle': '更多選項',
  'guide.moreDesc': '自動播放、使用說明等更多功能。',
